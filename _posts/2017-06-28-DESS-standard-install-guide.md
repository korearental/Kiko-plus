...
- [*2.2* *우분투 설치 USB* ](#2.2-우분투-설치-usb)

- [*2.3* *DESS 스탠다드 에디션 서버 설치 순서* ](#2.3-dess-스탠다드-에디션-서버-설치-순서)

[*3.* *DB 서버 설치* ](#3-db-서버-설치)

- [*3.1* *우분투 설치* ](#3.1-우분투-설치)

- [*3.2* *DBMS 설치* ](#3.2-dbms-설치)

- [*3.3* *MMS(=local server)로의 접근권한 부여* ](#3.3-mmslocal-server로의-접근권한-부여)

[*4.* *MMS 서버 (=local server) 설치* ](#4-mms-서버-local-server-설치)

- [*4.1* *파티션 설정* ](#4.1-파티션-설정)

- [*4.2* *우분투 설치* ](#4.2-우분투-설치-1)

- [*4.3* *Installer 실행* ](#4.3-installer-실행)

- [*4.4* *설치 페이지 열기* ](#4.4-설치-페이지-열기)

- [*4.5* *설치 페이지 실행* ](#4.5-설치-페이지-실행)

[*5.* *Q & A* 36](#5-q--a)

- [*5.1* *MMS(local server) 설치 시 오류 발생하는 경우* 36](#5.1-mmslocal-server-설치-시-오류-발생하는-경우)

- [*5.2* *디스크 파티션 설정 오류* 38](#5.2-디스크-파티션-설정-오류)
