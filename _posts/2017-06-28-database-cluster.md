...
- [*2.3* *서버 설치 순서* ](#23-서버-설치-순서)

[*3.* *우분투 설치* ](#3-우분투-설치)

- [*3.1* *우분투 설치* ](#31-우분투-설치-1)

[*4.* *DB 설치* ](#4--db-설치)

- [*4.1* *DB 설치* ](#41--db-설치)

- [*4.2* *DB Cluster 설정* ](#42-db-cluster-설정)

- [*4.3* *Grand Access for HAProxy Server* ](#43-grand-access-for-haproxy-server)

- [*4.4* *HA Proxy 설치* ](#44-ha-proxy-설치)

- [*4.5* *설치 검증하기* ](#45-설치-정상여부-검증하기)

[*5.* *Q & A* ](#5-q--a)

- [*5.1* *DB 접속 오류* ](#51-db-접속-오류-시)
